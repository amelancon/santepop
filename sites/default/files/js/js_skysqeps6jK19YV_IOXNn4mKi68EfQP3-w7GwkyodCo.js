...
(function ($) {
  ...
  Drupal.behaviors.activitesBlock = {
    attach: function(context, settings) {
      $('#soutien').addClass('not-hovering');
      $('#soutien').hover(function(e){
        console.log(e.type);
        $('#soutien')[e.type == 'mouseenter' ? 'removeClass' : 'addClass']('not-hovering');
      })
    }
  };
...
(function ($) {
  ...
  Drupal.behaviors.homeBlock = {
    attach: function(context, settings) {
      $('#prog_form .formations').hide();
      $('#prog_form').addClass('js').hover(
          function(){
            $('#prog_form .formations').show();
          },
          function(){
            $('#prog_form .formations').hide();
          }
